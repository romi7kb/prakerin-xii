                            ...
                            <table class="table table-striped  table-bordered align-middle " id="tabled">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td><a style="color:black;" href="/kelurahan/{{$data->id}}">{{ $data->nama_kec }}</a></td>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="credits">
                ...
                <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/Track-19-free-bootstrap-template-creative/ -->
